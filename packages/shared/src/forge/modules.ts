...
export const INNOVATION_MODULE: ModuleManifest = {
  ...
  ownedEntities: ['InnovationFiche', 'InnovationContributor', 'InnovationVote', 'InnovationChallenge', 'ChallengeEntry', 'InnovationOrgUnit', 'InnovationCategory', 'ChallengeCriterion', 'ChallengeJuror', 'ChallengeScore'],
  referencedPivots: ['User'],
  emits: [],
  listensTo: [],
}
