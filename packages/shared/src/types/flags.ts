...
export const FLAG_DEFINITIONS: FlagDefinition[] = [
  ...
  { key: 'module.innovation', label: 'Module Innovation', description: 'Active le module Innovation — fiches innovation et challenges (Hub + accès direct /innovation).', defaultEnabled: false },
]
