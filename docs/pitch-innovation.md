...
> **Total pour 10 personnes : 450 €/mois — 5 400 €/an** · données chez 5 prestataires différents
...
|--|--|--|
| Licences outils (×5) | 8 100 €/an | **0 €** |
| Infra hébergement | 0 € | **~360 €/an** |
| Conformité RGPD | ~500 €/an | **0 €** |
| **Total annuel** | **~8 600 €** | **~360 €** |

<br>

<span class="highlight">Économie : ~8 240 €/an pour 15 personnes → ROI positif dès le 1er mois</span>
...
|--|--|--|
| SaaS (licences + conformité) | ~8 600 €/an | **~165 000 €/an** |
| Pivot (infra dédiée) | ~360 €/an | **~2 400 €/an** |
| **Économie** | **~8 200 €** | **~162 600 €** |

> ~163 000 € économisés = 2 développeurs recrutés pour innover en interne
...
Aujourd'hui : 7 modules indépendants partageant une même identité.
