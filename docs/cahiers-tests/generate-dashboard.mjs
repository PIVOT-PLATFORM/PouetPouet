...
const SECTIONS = [
  ...
  },
  {
    ...
    tests: [
      { num: '8.1', action: 'Basculer en thème sombre (Profil -> Thème) et recharger le dashboard', expected: 'Dashboard, barre de navigation, cartes de boards : tout respecte le thème sombre.' },
    ],
  },
]
...
async function generate() {
  ...
  const outPath = 'docs/cahiers-tests/CT-v0.3.0-dashboard.pdf'
