    ...
    <>
      ...
      >
        <div className="vote-end-card-in flex flex-col items-center gap-5 text-center">
          ...
          <div className="w-36 h-48 rounded-2xl bg-gradient-to-br from-purple-500 to-indigo-600 flex flex-col items-center justify-center shadow-2xl gap-3">
          ...
          <div className="vote-end-badge-in inline-block bg-purple-50 rounded-2xl px-6 py-3">
            <p className="text-xs text-purple-400 font-medium mb-0.5">Affichage dans</p>
            <p className="text-sm font-bold text-purple-700">{countdown}s · Cliquez pour voir</p>
          </div>
