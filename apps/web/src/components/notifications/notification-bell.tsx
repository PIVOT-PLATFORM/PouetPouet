...
const TYPE_ICON: Record<NotificationType, { color: string; path: string }> = {
  ...
  WHEEL_DRAW: { color: 'text-violet-500 bg-violet-50 dark:bg-violet-950', path: 'M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15' },
  BOARD_IMPORTED: { color: 'text-teal-500 bg-teal-50 dark:bg-teal-950', path: 'M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M9 19l3 3m0 0l3-3m-3 3V10' },
}
