    ...
    <>
      <div className="absolute top-2 right-4 z-40 w-72 bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
        ...
        <div className="px-4 py-4 text-center border-b border-gray-100">
          ...
          <button
            onClick={copyCode}
            className="text-3xl font-bold tracking-[0.2em] text-indigo-600 hover:text-indigo-700 transition-colors font-mono block w-full"
          >
            {session.code}
          </button>
          <button
        ...
        <div className="px-4 py-4 border-b border-gray-100">
          {currentActivity ? (
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 rounded-lg bg-indigo-50 border border-indigo-200 px-3 py-2.5 text-sm font-medium text-indigo-600 hover:bg-indigo-100 transition-colors"
            >
