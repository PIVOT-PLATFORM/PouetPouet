...
const MODULES = [
  ...
  },
  {
    ...
    features: [
      ...
      'Items configurables : domaine, risque, priorité, statut, responsable, valeur business, dépendances',
      'Dépendances validées : pas de boucle possible, ids toujours du même roadmap',
      ...
      'Filtres par domaine, risque, priorité, statut et responsable',
      'Export PDF vectoriel A4 paysage, JSON et CSV',
      'Partage par rôle (Lecteur / Éditeur / Owner) ; rattachable à un Portefeuille',
    ],
  },
  {
    icon: '🗂️',
    title: 'Portefeuille',
    href: '/portfolio',
    desc: 'Vue consolidée de plusieurs roadmaps — pour un suivi transverse multi-projets.',
    features: [
      'Regroupe plusieurs roadmaps existantes (rattachement/détachement à tout moment)',
      'Timeline consolidée en lecture, filtrable par roadmap',
      'Accès transitif : un partage sur le portefeuille donne accès à toutes les roadmaps rattachées, sans les partager une à une',
      'Détacher une roadmap ou supprimer le portefeuille ne supprime jamais la roadmap',
